...
NS_IMPL_ISUPPORTS(nsAppFileLocProviderProxy,
...
NS_IMETHODIMP
nsAppFileLocProviderProxy::GetFile(const char* aProp, bool* aIsPersistant,
                                   nsIFile** aResult)
{
...
NS_IMPL_ISUPPORTS(DirectoryEnumerator, nsISimpleEnumerator)
